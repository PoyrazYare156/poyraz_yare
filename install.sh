...
if ! pip3 show requests &> /dev/null; then
    echo "Requests kütüphanesi yüklü değil. Yükleniyor..."
    pip3 install requests
fi

# Script dosyasını indirin
echo "PoyrazYare scripti indiriliyor..."
cat << 'EOF' > poyraz_yare.py
import requests
import time
import threading
import re
...
# Script'i çalıştır
echo "PoyrazYare scripti indirildi. Şimdi çalıştırılıyor..."
python3 poyraz_yare.py